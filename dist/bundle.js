...
function randerData(type, data) {
    ...
    for (var i = 0; i < data2.length; i++) {
        ...
        html += ['<div node-type="more" name="' + data2[i].name + '" class="item">', '<div class="floatL">' + data2[i].name + ' ' + p + '（' + data2[i].date + ')' + '</div>', '<div class="floatR" node-type="del" name="' + data2[i].name + '">删除</div>', '<div class="blankBox"></div>', '</div>'].join('');
    }
    (0, _jquery2.default)('.lists').html('').append(html);

    (0, _jquery2.default)('[node-type="more"]').off('click').on('click', function () {
...
function detail(name) {
    ...
    if (stockData.isOK) {
        (0, _jquery2.default)('[node-type="isOK"]').show();
        (0, _jquery2.default)('[node-type="isNotOK"]').hide();
    } else {
        (0, _jquery2.default)('[node-type="isOK"]').hide();
        (0, _jquery2.default)('[node-type="isNotOK"]').show();
    }
    ...
    (0, _jquery2.default)('.y1').css({ left: a1 < 100 ? a1 + '%' : '100%' });
    (0, _jquery2.default)('.y2').css({ left: a2 < 100 ? a2 + '%' : '100%' });
    (0, _jquery2.default)('.y3').css({ left: a3 < 100 ? a3 + '%' : '100%' });
    (0, _jquery2.default)('.y4').css({ left: a4 < 100 ? a4 + '%' : '100%' });
...
(0, _jquery2.default)('[node-type="startBtn"]').on('click', function () {
    (0, _jquery2.default)('[node-type="page1"]').hide();
    (0, _jquery2.default)('[node-type="page2"]').show();
});

(0, _jquery2.default)('.bar .tab').each(function (i) {
    (0, _jquery2.default)(this).on('click', function () {
        (0, _jquery2.default)('.bar .tab').removeClass('active');
...
(0, _jquery2.default)('.okBtn').on('click', function () {
    var name = (0, _jquery2.default)('[node-type="addName"]').val();
    var price = parseFloat((0, _jquery2.default)('[node-type="addPrice"]').val());
    var low1 = parseFloat((0, _jquery2.default)('[node-type="addLow1"]').val());
    var low2 = parseFloat((0, _jquery2.default)('[node-type="addLow2"]').val());
    var low3 = parseFloat((0, _jquery2.default)('[node-type="addLow3"]').val());
    var low4 = parseFloat((0, _jquery2.default)('[node-type="addLow4"]').val());
    var low5 = parseFloat((0, _jquery2.default)('[node-type="addLow5"]').val());
    var low6 = parseFloat((0, _jquery2.default)('[node-type="addLow6"]').val());

    if (_jquery2.default.trim(name) == '') {
        alert('名称不能为空!');return;
    }
    if (_jquery2.default.trim(price) == 'NaN') {
        alert('当前每股市价不能为空，或者输入值有误!');return;
    }
    if (_jquery2.default.trim(low1) == 'NaN') {
        alert('低点1不能为空，或者输入价格有误!');return;
    }
    if (_jquery2.default.trim(low2) == 'NaN') {
        alert('低点2不能为空，或者输入价格有误!');return;
    }
    if (_jquery2.default.trim(low3) == 'NaN') {
        alert('低点3不能为空，或者输入价格有误!');return;
    }
    if (_jquery2.default.trim(low4) == 'NaN') {
        alert('低点4不能为空，或者输入价格有误!');return;
    }
    if (_jquery2.default.trim(low5) == 'NaN') {
        alert('低点5不能为空，或者输入价格有误!');return;
    }
    if (_jquery2.default.trim(low6) == 'NaN') {
        alert('低点6不能为空，或者输入价格有误!');return;
    }
